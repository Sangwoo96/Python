...
def checkPointScored(paddle2, ball, score, ballDirX):
...
def artificialIntelligenceRight(ball, ballDirX, paddle2):
...
def main():
    ...
    paddle1 = pygame.Rect(PADDLEOFFSET, playerOnePosition,
    ...
    while True:  # main game loop
        ...
        score = checkPointScored(paddle2, ball, score, ballDirX)
        ballDirX = ballDirX * checkHitBall(ball, paddle1, paddle2, ballDirX)
        paddle2 = artificialIntelligenceRight(ball, ballDirX, paddle2)
